        ...
        <div class="card login-card shadow-lg">
            <div class="card-body p-4">
                <div class="text-center mb-3">
                    <img src="{{ asset('images/ido-logo.jpg') }}" alt="İDO" style="height:70px; width:auto;">
                </div>
                <h1 class="h4 mb-4 text-center">Toplantı Yönetim Sistemi</h1>
    ...
    <div class="form-text">Kayıt sırasında size verilen 6 haneli numara (örn: 000001).</div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="password" id="password_field" class="form-control" required minlength="6" maxlength="6" autocomplete="off">
                            <button type="button" class="btn btn-outline-secondary" id="toggle_password" tabindex="-1">
                        ...
                        <div class="form-text">Şifre tam olarak 6 karakter olmalıdır.</div>
                    </div>
                ...
                <script>
                    document.getElementById('toggle_password').addEventListener('click', function () {
                        ...
                        if (input.type === 'password') {
                            input.type = 'text';
                            icon.innerHTML = '<path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a18.5 18.5 0 0 1 5.06-5.94M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line>';
                        } else {
                            input.type = 'password';
